...
export const config = {
  ...
  PANEL_ENABLED: (process.env.PANEL_ENABLED || '').toLowerCase() !== 'false',
  M3U_ENABLED: (process.env.M3U_ENABLED || '').toLowerCase() !== 'false',
  VLC_ENABLED: (process.env.VLC_ENABLED || '').toLowerCase() !== 'false',
